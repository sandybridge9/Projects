				...
				if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
					...
					if($_SESSION['user_level'] == "vartotojas"){
						...
						<table>
							...
							<tr>
							<td>
							<a href=\"order_list.php\">Užsakytų prekių sąrašas</a>
							</td>
							</tr>
						</table>
						</div>
					...
					elseif($_SESSION['user_level'] == "isveziotojas"){
						echo "
						<div class=\"llu\">
							<a href=\"buhalter.php\"> Isvežiotojas </a>
							<a href=\"profile.php\"> $username </a>
							<a href=\"logout.php\"> Logout </a>
						</div>
						<div class=\"profile-group\">
						<table>
							...
							<tr>
							<td>
							<a href=\"full_order_list.php\">Visų vartotojų užsakytų prekių sąrašas</a>
							</td>
							<td>
							<a href=\"transport_edit.php\">Išvežiojimo priemonės talpos redagavimas</a>
							</td>
							</tr>
						</table>
						</div>
